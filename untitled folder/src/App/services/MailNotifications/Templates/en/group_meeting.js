...
<body>
	<div class="mail">
		...
		<div class="body_mail">
			...
			<div class="content">
				<h1>Soon there will be group meetings of the languages you are studying nearby.<br><br>Join!</h1>
				<div class="jays">
					<div class="jay">
            <div class="avatar">
            ...
            <div class="clear"></div>
					...
					<div>
						<h2>What to make to join a group meeting?</h2>
						<ol>
							<li>Open "Hi, Jay!" app
							<li>Go to "Meetings" section
							<li>Go to the necessary group meeting profile
						</ol>
					</div>
				</div>
				<ul class="downloads">
