export default (ctx, emailParams = {}) => {
  const data = {
    profile: {},
    jaysCount: emailParams.jaysCount || 0,
  }
				...
				<div class="jays">
					<div class="jay">
						...
						<div class="meeting reject">
								<div><b>${data.profile.name}</b> declined your suggestion to meet.</div>
						</div>
						<div class="clear"></div>
					</div>
					<div ${!data.jaysCount ? 'style="display: none"' : ''}>
						<p>There are ${data.jaysCount} Jays nearby, that can help you to practice ${data.profile.language}. Choose any of them and suggest him to meet.</p>
					</div>
				</div>
				<ul class="downloads">
