...
export default function getDocs(ctx, params) {
  return Object.assign({
    ...
    "host": ctx.config.host + ':' + ctx.config.swagger.port + '/api',
    "schemes": [
      ctx.config.protocol,
    ],
    "basePath": "/v2",
    ...
    "paths": {
          ...
          "parameters": [
            {
              "name": "secret",
              "in": "query",
              "description": "&nbsp#piupiu!!!QWErty123HiJAY_2016#",
              "required": true,
              "type": "string"
            },
            {
          ...
          "parameters": [
            {
              "name": "secret",
              "in": "query",
              "description": "&nbsp#piupiu!!!QWErty123HiJAY_2016#&nbsp",
              "required": true,
              "type": "string"
            }, {
              "name": "description",
      ...
      "/profiles/filter": {
        "get": {
          "summary": "Постраничное поиск пользователей",
          "parameters": [
            {
              "name": "limit",
              "in": "query",
              "required": false,
              "type": "number",
              "description": "Лимит юзеров на странице"
            },
            {
              "name": "offset",
              "in": "query",
              "required": false,
              "type": "number",
              "description": "Пропустить это количество юзеров"
            },
            {
              "name": "lat",
              "in": "query",
            ...
            },
            {
              ...
              "required": false,
              "type": "number",
              "description": "Максимальная дистанция от указанных координат"
            },
            {
              "name": "language",
              "in": "query",
              "required": false,
              "type": "string",
              "description": "Родной язык(можно через запятую)"
            },
          ],
          "tags": ["Profiles"],
          "responses": {
            "200": {
              "description": "Массив юзеров",
              "schema": {
                "$ref": "#/definitions/Profile"
              }
            }
      ...
      "/profiles/validate/": {
        "get": {
          "summary": "Проверить занят ли email",
          "tags": ["Profiles"],
          "parameters": [
            {
              "name": "email",
      ...
      "/requests/{request_id}/unsafeConfirm": {
        "parameters": [
          {
            "name": "request_id",
            "in": "path",
        ...
        "post": {
          "summary": "Подтвердить запрос или назначить время и место",
          "tags": [
            "Requests"
          ],
          "parameters": [
          ...
          "parameters": [
            {
              "name": "language",
              "in": "query",
              "description": "язык (можно через запятую)",
              "required": false,
              "type": "string"
            },
            {
        ...
        "get": {
          ...
          "parameters": [
            ...
            },
            {
              "name": "anyLanguage",
              "in": "query",
              "description": "Поиск по нативному и изучаемым языкам",
              "required": false,
              "type": "string"
            },
            {
              "name": "nativeLanguage",
              "in": "query",
              "description": "Поиск по родному языку",
              "required": false,
              "type": "string"
            },
            {
              "name": "learningLanguages",
              "in": "query",
              "description": "Поиск по изучаемым языкам",
              "required": false,
              "type": "string"
            },
            {
      ...
      "/profiles/map": {
        "get": {
          "summary": "Получение данных для отображения маркеров на карте",
          "tags": [
            "Profiles"
          ],
          "parameters": [
            ...
            },
            {
              ...
              "required": false,
              "type": "number",
              "description": "Минимальное количество юзеров в кластере"
            },
            {
              "name": "only",
              "in": "query",
              "required": false,
              "type": "string",
              "description": "Вернуть только кластеры/юзеров ['clusters', 'users']"
            },
          ],
          "responses": {
            "200": {
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description":"Тип сообщения: [sign_in, group_meeting, meeting_confirmited, meeting_rejected, recover_password, request_meeting_help_me, request_meeting_help_you]",
            "type": "string"
          },
        ],
        "get": {
          "summary": "Тестирование email уведомлений",
          "tags": ["Email"],
          "parameters": [
            {
              "name": "email",
              "in": "query",
              "required": true,
              "description":"Email на который отправить письмо",
              "type": "string"
            },
          ],
          "responses": {
      ...
      "/notifications/message/{id}": {
        ...
        "post": {
          "summary": "Прочитать все сообщения от собеседника",
      ...
      "/messages/read/{id}": {
        ...
        "post": {
          "summary": "Прочитать все сообщения от юзера",
          "description": "В поле ID нужно указать ID собеседника",
          "tags": ["Messages"],
          "responses": {
            "200": {
              "description": "",
